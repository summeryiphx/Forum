...
function getId(element) {
  if (typeof element.dataset === 'undefined') {
    return element.getAttribute('data-ps-qusetion_id');
  } else {
...
function setId(element, id) {
  if (typeof element.dataset === 'undefined') {
    element.setAttribute('data-ps-qusetion_id', id);
  } else {
...
function removeId(element) {
  if (typeof element.dataset === 'undefined') {
    element.removeAttribute('data-ps-qusetion_id');
  } else {
...
(function (){
	...
	function getExternalContainer() {
		return '<li qusetion_id="entrypoint-objects"></li>';
	}
})();
