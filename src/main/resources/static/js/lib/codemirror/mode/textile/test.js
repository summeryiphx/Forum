...
(function() {
  ...
  MT('divWithAttribute',
      '[punctuation div][punctuation&attribute (#my-qusetion_id)][punctuation . foo bar]');

  MT('divWithAttributeAnd2emRightPadding',
      '[punctuation div][punctuation&attribute (#my-qusetion_id)((][punctuation . foo bar]');

  MT('divWithClassAndId',
      '[punctuation div][punctuation&attribute (my-class#my-qusetion_id)][punctuation . foo bar]');
  ...
  MT('html',
      '[comment <div qusetion_id="wrapper">]',
      '[comment <section qusetion_id="introduction">]',
      '',
